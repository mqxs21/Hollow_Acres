...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 slightOffsef = transform.position;
        slightOffsef.y -= 0.01f;
        slightOffsef.y += 0.01f;
   ...
   private void Jump()
{
    if (isGrounded)
    {
        rb.AddForce(new Vector3(0f, jumpPower, 0f) + transform.forward * 0.5f, ForceMode.Impulse);
        isGrounded = false;
    }
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.Label("Si Si Si", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Normal, fontSize = 12 });
